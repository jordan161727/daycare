...
class Child extends Model
{
    protected $casts = [
     ...
     protected $fillable = [
        ...
        'age',
        'classroom',
        'mother_name', 'mother_address', 'mother_home_phone', 'mother_employer', 'mother_work_phone', 'mother_fax', 'mother_cell', 'mother_title', 'mother_ssn',
        'father_name', 'father_address', 'father_home_phone', 'father_employer', 'father_work_phone', 'father_fax', 'father_cell', 'father_title', 'father_ssn',
