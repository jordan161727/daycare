...
<div class="no-print glass-card rounded-2xl px-3 py-2.5">
    <div class="flex flex-wrap items-center gap-x-3 gap-y-2">
        ...
        <div class="flex items-center gap-1 rounded-lg bg-slate-100 p-0.5 dark:bg-slate-800">
            <button type="button" @click="view = 'sheet'" :class="view === 'sheet' ? 'bg-white text-slate-900 shadow-sm dark:bg-night-700 dark:text-night-950' : 'text-slate-500 hover:text-slate-700 dark:text-slate-400'" class="rounded-md px-2.5 py-1 text-xs font-semibold transition">Daily sheet</button>
            <button type="button" @click="view = 'summary'" :class="view === 'summary' ? 'bg-white text-slate-900 shadow-sm dark:bg-night-700 dark:text-night-950' : 'text-slate-500 hover:text-slate-700 dark:text-slate-400'" class="rounded-md px-2.5 py-1 text-xs font-semibold transition">Class report</button>
        </div>
